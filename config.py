...
class Config:
    ...
    n_stages = 3
    n_blocks = [1, 3, 1]  # [1, 1, 3, 1]

    channels = [n_C, 2*n_C, 4*n_C] #[n_C, 2*n_C, 4*n_C, 8*n_C]

    kernel_sizes =  [7, 7, 7]  # [7, 7, 7, 5]
    strides =       [1, 1, 1]  # [1, 1, 1, 1] 
    downsampling_kernel_sizes = [2, 2]  # [2, 2, 2]
    ...
    run_name = 'Test-LinearPW|Light-InvertedBottleneck|CSnnNext-Delays|stem7|bins=1|3-stages|n_C=16'
